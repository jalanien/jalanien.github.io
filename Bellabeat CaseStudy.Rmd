...
-1 Uploaded 4 of the 18 available CSV files,  dailyActivity_merged.csv, dailyIntensities_merged.csv, sleepSteps_merged.csv, and dailyCalories_merged.csv. Changed names to daily_activies, daily_intensities, and daily_steps and daily_calories. The date formate was also updated for all datasets.
 
 
-2 Checked daily_activity, daily_steps, daily_calories, and daily_intensities for duplicates, NA/NULL and proper naming conventions.  
```{r}
